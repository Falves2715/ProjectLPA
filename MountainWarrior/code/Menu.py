...
class Menu:
    ...
    def run(self):
        pygame.mixer_music.load('./assets/Menu.flac')
        ...
        while True:
            ...
            self.menu_text(50, "Warrior", COLOR_ORANGE, (WIN_WIDTH / 2, 120))
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:  # testar se alguma tecla foi pressionada
                    if event.key == pygame.K_DOWN:  # se a seta pra baixo foi pressionada
                        if menu_option < len(MENU_OPTION) - 1:
                            menu_option += 1
                        else:
                            menu_option = 0
                if event.type == pygame.KEYDOWN:  # testar se alguma tecla foi pressionada
                    if event.key == pygame.K_UP:  # se a seta pra cima foi pressionada
                        if menu_option > 0:
                            menu_option -= 1
                        else:
